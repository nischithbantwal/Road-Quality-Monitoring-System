...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'F:\thisisdb\StudentManagement-System-dbms-miniproject-main\myenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'F:\thisisdb\StudentManagement-System-dbms-miniproject-main\myenv\Scripts\deactivate.nu'
